...
%% @doc Gets the root hash of the given skewed tree. This is a fast
...
%% @doc Get the height of the given skewed tree. This is a fast
%% operation since the hash was calculated on construction of the
%% tree.
...
%% @doc get the number of leaves int he skewed tree.
-spec count(skewed()) -> non_neg_integer().
count(#skewed{count=Count}) ->
    Count.

%% @doc A commonly used hash value for skewed trees. This function
